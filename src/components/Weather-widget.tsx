...
export default function WeatherWeigeht() {
    ...
    function getTemperatureMessage(temperature:number, unit: string):string {
        if(unit == "C") {
            if(temperature < 0){
                return `It's freezing at ${temperature}°C! Bandle up!`;
            } 
            else if (temperature < 10){
                return `It's quite cold at ${temperature}°C. Ware warm clothes.`;
            ...
            //Placeholder for orther temperature units (e.g, Fahrenheit)
    ...
    function getWeatherMessage (description:string):string {
        switch (description.toLocaleLowerCase()) {
            ...
            case "thunderstorm":
             return "Thuunderstorm are expected today.";
             case "snow":
             return "Bandle up! It's snowing.";
             case "mist":
     ...
     return (
        <div className="flex justify-center bg-blue-300 items-center h-screen ">
            <Card className="w-full max-w-md mx-auto text-center bg-blue-400">
                <CardHeader>
